...
function PrintExecution(target, propertyKey, descriptor) {
...
var Student = function () {
    ...
    return _a = /** @class */ (function () {
            ...
            Student.prototype.getRollNo = function () {
                console.log("My roll number is ".concat(this.rollno));
            };
            return Student;
        }()),
        (function () {
            ...
            _getRollNo_decorators = [PrintExecution];
            ...
            __esDecorate(_a, null, _getRollNo_decorators, { kind: "method", name: "getRollNo", static: false, private: false, access: { has: function (obj) { return "getRollNo" in obj; }, get: function (obj) { return obj.getRollNo; } }, metadata: _metadata }, null, _instanceExtraInitializers);
            if (_metadata) Object.defineProperty(_a, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        })(),
        _a;
}();
var user = new Student("Karthik", 101);
user.sayHello();
user.getRollNo();
